      ...
      <Pressable onPress={Keyboard.dismiss} style={styles.inner}>
        ...
        <View style={styles.logoContainer}>
          ...
          <Text
            style={[
              typography.h4,
              { color: colors.text, fontWeight: "800", marginTop: 10 },
            ]}
          >
            Welcome Back
          </Text>
        ...
        <View style={styles.form}>
          ...
          <Text
            style={[
              styles.label,
              { color: colors.text, opacity: 0.6, marginTop: spacing.md },
            ]}
          >
          ...
          >
            {loading ? (
              ...
              <Text
                style={[
                  typography.button,
                  { color: colors.inverted, fontSize: 18 },
                ]}
              >
          ...
          <View style={styles.footer}>
            <Text
              style={[typography.body1, { color: colors.text, opacity: 0.7 }]}
            >
